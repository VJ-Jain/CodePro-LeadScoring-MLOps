...
DB_PATH = 'Assignment/01_data_pipeline/scripts/unit_test/'
DB_FILE_NAME = 'utils_output.db'
UNIT_TEST_DB_FILE_NAME = 'unit_test_cases.db'
DATA_DIRECTORY = 'Assignment/01_data_pipeline/scripts/unit_test/'
LEAD_SCORING_CSV = 'leadscoring_test.csv'
INTERACTION_MAPPING = 'Assignment/01_data_pipeline/scripts/unit_test/interaction_mapping.csv'
